...
def lisensi():
	try:
		...
		tlisensi()
	ses=requests.Session()
	res=requests.get('https://github.com/Nil500/Approval.txt/blob/main/Approval.txt.io/api/key/Activate?token=WyIxOTgzMDgxOCIsImtjQTQwRjVVSGlNNzRub1k2dllNajBSY2JjMUgyY2MrS3hqN1F6c0QiXQ==&ProductId=E74XOS4X2J78ZZH2O8YZ2W2ZYY1K3XJ04QXX&Key='+lisensikuni[0]).json())
